...
class UpdateStatus extends Component
{
    ...
    public function change(){
        ...
        //Notification to the user that applied
            ...
            $details['greeting'] = 'Dear , '. $this->request->user->name;
            $details['subject'] = 'Request Status Changed';
            $details['body'] = "<p>The  status of your Document Requested number {$trans_no} has been marked as {$status}  </p>
                                ";
    ...
    {
        return view('livewire.admin.request.update-status');
    }
}
