        ...
        >
            <div class="modal-inner">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">{{$isEditMode?  __('edits.edit_category') : __('edits.add_category')}}</h5>
                </div>


                <div class=" form-group col-12">
                    <label>{{__('edits.type')}}<span class="text-danger">*</span></label>
