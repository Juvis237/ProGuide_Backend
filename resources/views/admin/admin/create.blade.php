                    ...
                    <form method="post" action="{{route('admin.administrator.store')}}">
                       ...
                       <div class="row">
                           <div class="form-group col-md-6">
                               ...
                               <input class="form-control @error('name') is-invalid @enderror" type="text" value="{{old('name')}}" name="name" placeholder="Enter name of administrator">
                               @error('name')
                           ...
                           <div class="form-group col-sm-6">
                               <label>Email</label>
                               <input class="form-control @error('email') is-invalid @enderror" type="email" value="{{old('email')}}" name="email" placeholder="Enter email address of administrator">
                               @error('email')
                                    <span class="invalid-feedback">{{ $message }}</span>
                               @enderror
                           </div>
                           <div class="form-group col-sm-6 @error('phone') is-invalid @enderror">
                               ...
                               <input class="form-control @error('phone') is-invalid @enderror" type="number" value="{{old('phone')}}" name="phone" placeholder="Enter telephone of administrator">
                               @error('phone')
                                    <span class="invalid-feedback">{{ $message }}</span>
                               @enderror
                           </div>
