...
} elseif ($_instance->childHasBeenRendered('l228269108-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l228269108-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l228269108-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l228269108-0');
} else {
    $response = \Livewire\Livewire::mount('admin.categories.edit', ['type' => $type]);
    $html = $response->html();
    $_instance->logRenderedChild('l228269108-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php
...
} elseif ($_instance->childHasBeenRendered('l228269108-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l228269108-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l228269108-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l228269108-1');
} else {
    $response = \Livewire\Livewire::mount('admin.categories.add-sub', []);
    $html = $response->html();
    $_instance->logRenderedChild('l228269108-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l228269108-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l228269108-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l228269108-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l228269108-2');
} else {
    $response = \Livewire\Livewire::mount('admin.categories.delete', []);
    $html = $response->html();
    $_instance->logRenderedChild('l228269108-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
</div>
<?php /**PATH /home/zeh/Desktop/Pro/ProGuide_Backend/resources/views/livewire/admin/categories/index.blade.php ENDPATH**/ ?>