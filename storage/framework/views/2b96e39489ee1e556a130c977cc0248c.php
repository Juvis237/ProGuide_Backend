...
} elseif ($_instance->childHasBeenRendered('l498690434-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l498690434-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l498690434-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l498690434-0');
} else {
    $response = \Livewire\Livewire::mount('admin.pages.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l498690434-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php /**PATH /home/studmtdc/ProGuide_Backend/core/ProGuide_Backend/resources/views/livewire/admin/pages/index.blade.php ENDPATH**/ ?>