    ...
    >
        <div class="modal-inner modal-sm">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('edits.delete_faq')); ?></h5>
            </div>
            <div class="modal-body ">
                 <p class="text-center"> <?php echo e(__('edits.other_deletes')); ?>?</p>
                <?php if(isset($faq)): ?>
                 <p class="text-center"> <?php echo e(__('tables.question')); ?> : <span><?php echo e($faq->question); ?></span></p>
                <?php endif; ?>
            </div>
...
<?php /**PATH /home/studmtdc/ProGuide_Backend/core/ProGuide_Backend/resources/views/livewire/admin/faq/delete.blade.php ENDPATH**/ ?>