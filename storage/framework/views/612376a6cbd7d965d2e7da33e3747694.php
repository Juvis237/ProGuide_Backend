...
} elseif ($_instance->childHasBeenRendered('l255953216-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l255953216-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l255953216-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l255953216-0');
} else {
    $response = \Livewire\Livewire::mount('admin.school.delivrable.modes.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l255953216-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php /**PATH /Users/ivanotechs/Documents/ProGuide/proguide_be/resources/views/livewire/admin/school/delivrable/modes/index.blade.php ENDPATH**/ ?>