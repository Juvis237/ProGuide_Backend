...
} elseif ($_instance->childHasBeenRendered('l3758356075-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3758356075-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3758356075-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3758356075-0');
} else {
    $response = \Livewire\Livewire::mount('admin.faq.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3758356075-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3758356075-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3758356075-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3758356075-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3758356075-1');
} else {
    $response = \Livewire\Livewire::mount('admin.faq.delete', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3758356075-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
<?php /**PATH /Users/ivanotechs/Documents/ProGuide/proguide_be/resources/views/livewire/admin/faq/index.blade.php ENDPATH**/ ?>