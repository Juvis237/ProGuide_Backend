...
} elseif ($_instance->childHasBeenRendered('l3022867594-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3022867594-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3022867594-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3022867594-0');
} else {
    $response = \Livewire\Livewire::mount('admin.categories.edit', ['type' => $type]);
    $html = $response->html();
    $_instance->logRenderedChild('l3022867594-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php
...
} elseif ($_instance->childHasBeenRendered('l3022867594-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3022867594-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3022867594-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3022867594-1');
} else {
    $response = \Livewire\Livewire::mount('admin.categories.add-sub', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3022867594-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3022867594-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3022867594-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3022867594-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3022867594-2');
} else {
    $response = \Livewire\Livewire::mount('admin.categories.delete', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3022867594-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
</div>
<?php /**PATH /home/studmtdc/ProGuide_Backend/core/ProGuide_Backend/resources/views/livewire/admin/categories/index.blade.php ENDPATH**/ ?>