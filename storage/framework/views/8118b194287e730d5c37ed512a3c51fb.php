    ...
    >
        <div class="modal-inner">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('edits.delete_user')); ?> </h5>
            </div>
            <div class="modal-body ">
                 <p class="text-center"> <?php echo e(__('edits.delete_user_question')); ?> ?</p>
                <?php if(isset($user)): ?>
                 <p class="text-center"> <?php echo e(__('common.name')); ?> : <span><?php echo e($user->name); ?></span></p>
                <?php endif; ?>
            </div>
...
<?php /**PATH /home/studmtdc/ProGuide_Backend/core/ProGuide_Backend/resources/views/livewire/admin/users/delete.blade.php ENDPATH**/ ?>