        ...
        <div class="modal-inner">
            ...
            <div class="modal-body row">
                <div class=" form-group col-12">
                    ...
                    <input type="text" disabled  wire:model="delivrable_name" class="form-control">
                    <?php $__errorArgs = ['delivrable_name'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class=" form-group col-12">
                    <label>Mode Name<span class="text-danger">*</span></label>
...
<?php /**PATH /home/studmtdc/ProGuide_Backend/core/ProGuide_Backend/resources/views/livewire/admin/school/delivrable/modes/edit.blade.php ENDPATH**/ ?>