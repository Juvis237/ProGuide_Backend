        ...
        >
            <div class="modal-inner modal-sm">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('edits.delete_category')); ?></h5>
                </div>
                <div class="modal-body ">
                     <p class="text-center"> <?php echo e(__('edits.other_deletes')); ?> ?</p>
                    <?php if(isset($categories)): ?>
                     <p class="text-center"> <?php echo e(__('common.name')); ?> : <span><?php echo e($categories->name); ?></span></p>
                    <?php endif; ?>
                </div>
...
<?php /**PATH /home/studmtdc/ProGuide_Backend/core/ProGuide_Backend/resources/views/livewire/admin/categories/delete.blade.php ENDPATH**/ ?>