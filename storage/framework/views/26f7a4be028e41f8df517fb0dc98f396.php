...
} elseif ($_instance->childHasBeenRendered('l4170401205-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4170401205-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4170401205-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4170401205-0');
} else {
    $response = \Livewire\Livewire::mount('admin.school.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4170401205-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l4170401205-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4170401205-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4170401205-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4170401205-1');
} else {
    $response = \Livewire\Livewire::mount('admin.school.delete', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4170401205-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
<?php /**PATH /Users/ivanotechs/Documents/ProGuide/proguide_be/resources/views/livewire/admin/school/index.blade.php ENDPATH**/ ?>