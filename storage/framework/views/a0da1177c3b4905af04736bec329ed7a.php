...
} elseif ($_instance->childHasBeenRendered('l3614329113-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3614329113-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3614329113-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3614329113-0');
} else {
    $response = \Livewire\Livewire::mount('admin.blog.edit', ['type' => $type]);
    $html = $response->html();
    $_instance->logRenderedChild('l3614329113-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l3614329113-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3614329113-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3614329113-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3614329113-1');
} else {
    $response = \Livewire\Livewire::mount('admin.blog.delete', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3614329113-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l3614329113-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3614329113-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3614329113-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3614329113-2');
} else {
    $response = \Livewire\Livewire::mount('admin.blog.publish', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3614329113-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>

<?php /**PATH /home/studmtdc/ProGuide_Backend/core/ProGuide_Backend/resources/views/livewire/admin/blog/index.blade.php ENDPATH**/ ?>