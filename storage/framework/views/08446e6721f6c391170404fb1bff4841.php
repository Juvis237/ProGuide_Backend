...
} elseif ($_instance->childHasBeenRendered('fTfxMTc')) {
    $componentId = $_instance->getRenderedChildComponentId('fTfxMTc');
    $componentTag = $_instance->getRenderedChildComponentTagName('fTfxMTc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fTfxMTc');
} else {
    $response = \Livewire\Livewire::mount('admin.notifications', []);
    $html = $response->html();
    $_instance->logRenderedChild('fTfxMTc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/studmtdc/ProGuide_Backend/core/ProGuide_Backend/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>